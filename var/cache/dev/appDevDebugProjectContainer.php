...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2' => 'get17138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2Service',
            '2_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2' => 'get27138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2Service',
        ...
        $this->privates = array(
            '1_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2' => true,
            '2_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2']) ? $this->services['1_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2'] : $this->get17138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2']) ? $this->services['2_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2'] : $this->get27138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_108889943e7bd884ef3331278c7c639f025e4729feb4ebfe7cef0a8a73302b34');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a074162842230db3c07e64520d858e5dc5bbc339');
    }
    ...
    /**
     * Gets the '1_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get17138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2Service()
    {
        return $this->services['1_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get27138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2Service()
    {
        return $this->services['2_7138da5922b19d29ba2c5269d3a3e293ba03a80ce47d9b4b3a761683cf8f3bb2'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('tXk8WtXqzk', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rnTQnyQCP2', 0, 'eGTecFnyeKxk00YFEV50w-', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SRusRpbY9O', 0, 'eGTecFnyeKxk00YFEV50w-', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PondO22i-s', 0, 'eGTecFnyeKxk00YFEV50w-', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5967dd172774d4.19333963');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'a074162842230db3c07e64520d858e5dc5bbc339',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'a074162842230db3c07e64520d858e5dc5bbc339',
